//! Native Apple widget integration for Sikhar.
//!
//! This crate provides bindings to AppKit (macOS) and UIKit (iOS/iPadOS)
//! to enable native widget integration with Sikhar's widget system.
...
pub trait NativeWidgetRegistration {
    ...
    fn register_with_manager(&self, widget_id: sikhar_layout::WidgetId, manager: &mut ViewManager);
}
